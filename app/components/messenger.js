    ...
    return (
        <>
            ...
            <View style={Styles.sub1}>
                <Pressable onPress={() => { router.push('/components/profile') }}>
                    <Image
                ...
                <Pressable onPress={() => { router.push('/components/messenger') }} style={Styles.focus}>
                    <Image
                        source={require('../../public/msg.png')}
                        style={Styles.icon}
                    />
                </Pressable>
                <Pressable onPress={() => { router.push('/components/settings') }}>
                    <Image
